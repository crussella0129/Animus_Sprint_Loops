...
- [ ] T-002 (sprint 13): test→loop pass path requires sprint-tests/critique.md + selftest routing steps — touches: {4 bundles}/scripts/{current-phase,selftest}.sh
- [ ] T-003 (sprint 13): document both gates (phases 03/05, oh particles 03/07, ROADMAP §6) — touches: claude+codex phases/03, phases/05, oh particles 03+07, ROADMAP.md
